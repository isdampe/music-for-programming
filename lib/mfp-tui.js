...
class MfpTui
{
	 ...
	 * @return {Void}
	 */
	setStatusText(text, bold, volume) {
		let status = text;
		if (bold)
	...
	/**
	 * Selects the track for a given index.
	 * @param {Number} The index of the track to select.
	 * @return {Void}
	 */
	setSelectedTrack(idx) {
		this._albumList.select(idx);
	}
}
